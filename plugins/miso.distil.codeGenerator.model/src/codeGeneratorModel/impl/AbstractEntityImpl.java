 ...
 * <ul>
 *   <li>{@link codeGeneratorModel.impl.AbstractEntityImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link codeGeneratorModel.impl.AbstractEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AbstractEntityImpl extends MinimalEObjectImpl.Container implements AbstractEntity {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodeGeneratorModelPackage.ABSTRACT_ENTITY__NAME, oldName, name));
	}
