 ...
 * generated by Xtext
 */
package miso.carrascal.codeGenerator.formatting;
...
public class RulesFormatter extends AbstractDeclarativeFormatter {
  ...
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._rulesGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._rulesGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._rulesGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._rulesGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._rulesGrammarAccess.getML_COMMENTRule();
