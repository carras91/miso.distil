...
public class generateJson {
  ...
  public CharSequence write(final Artifact artifact) {
    ...
    {
      boolean _contains_3 = basicServices.contains(ServiceEnum.UPDATE_LITERAL);
      if (_contains_3) {
    ...
    {
      boolean _or_2 = false;
      boolean _contains_7 = basicServices.contains(ServiceEnum.UPLOAD_LITERAL);
      if (_contains_7) {
        _or_2 = true;
      } else {
    ...
    _builder.newLine();
    {
      boolean _contains_11 = basicServices.contains(ServiceEnum.UPDATE_LITERAL);
      if (_contains_11) {
        _builder.append("\t");
                  ...
                  if (_isRequired_1) {
                    {
                      ...
                      boolean _equals = _data.equals(DataEnum.STRING_LITERAL);
                      if (!_equals) {
                        _and = false;
                      } else {
                      ...
                      if (_and) {
                        ...
                        boolean _equals_1 = _data_1.equals(DataEnum.INTEGER_LITERAL);
                        if (!_equals_1) {
                          _and_1 = false;
                        } else {
                        ...
                        if (_and_1) {
                          ...
                          boolean _equals_2 = _data_2.equals(DataEnum.DOUBLE_LITERAL);
                          if (!_equals_2) {
                            _and_2 = false;
                          } else {
                          ...
                          if (_and_2) {
                            ...
                            boolean _equals_3 = _data_3.equals(DataEnum.BOOLEAN_LITERAL);
                            if (!_equals_3) {
                              _and_3 = false;
                            } else {
                            ...
                            if (_and_3) {
                              ...
                              boolean _equals_4 = _data_4.equals(DataEnum.STRING_LITERAL);
                              if (_equals_4) {
                                _builder.append("\t");
                                _builder.append("\t\t");
                                _builder.append(newName, "\t\t\t");
                                ...
                                boolean _equals_5 = _data_5.equals(DataEnum.INTEGER_LITERAL);
                                if (_equals_5) {
                                  _builder.append("\t");
                                  _builder.append("\t\t");
                                  _builder.append(newName, "\t\t\t");
                                  ...
                                  boolean _equals_6 = _data_6.equals(DataEnum.DOUBLE_LITERAL);
                                  if (_equals_6) {
                                    _builder.append("\t");
                                    _builder.append("\t\t");
                                    _builder.append(newName, "\t\t\t");
                                    ...
                                    boolean _equals_7 = _data_7.equals(DataEnum.BOOLEAN_LITERAL);
                                    if (_equals_7) {
                                      _builder.append("\t");
                                      _builder.append("\t\t");
                                      _builder.append(newName, "\t\t\t");
    ...
    {
      boolean _contains_12 = basicServices.contains(ServiceEnum.UPLOAD_LITERAL);
      if (_contains_12) {
        _builder.append("\t");
        _builder.append("@Override");
        _builder.newLine();
                  ...
                  if (_isRequired_3) {
                    {
                      ...
                      boolean _equals_8 = _data_8.equals(DataEnum.BOOLEAN_LITERAL);
                      if (!_equals_8) {
                        _and_4 = false;
                      } else {
                      ...
                      if (_and_4) {
                        ...
                        boolean _equals_9 = _data_9.equals(DataEnum.INTEGER_LITERAL);
                        if (!_equals_9) {
                          _and_5 = false;
                        } else {
                        ...
                        if (_and_5) {
                          ...
                          boolean _equals_10 = _data_10.equals(DataEnum.DOUBLE_LITERAL);
                          if (!_equals_10) {
                            _and_6 = false;
                          } else {
                          ...
                          if (_and_6) {
                            ...
                            boolean _equals_11 = _data_11.equals(DataEnum.STRING_LITERAL);
                            if (!_equals_11) {
                              _and_7 = false;
                            } else {
                            ...
                            if (_and_7) {
                              ...
                              boolean _equals_12 = _data_12.equals(DataEnum.INTEGER_LITERAL);
                              if (_equals_12) {
                                _builder.append("\t");
                                _builder.append("\t\t");
                                _builder.append(type, "\t\t\t");
                                ...
                                boolean _equals_13 = _data_13.equals(DataEnum.DOUBLE_LITERAL);
                                if (_equals_13) {
                                  _builder.append("\t");
                                  _builder.append("\t\t");
                                  _builder.append(type, "\t\t\t");
                                  ...
                                  boolean _equals_14 = _data_14.equals(DataEnum.STRING_LITERAL);
                                  if (_equals_14) {
                                    _builder.append("\t");
                                    _builder.append("\t\t");
                                    _builder.append(type, "\t\t\t");
                                    ...
                                    boolean _equals_15 = _data_15.equals(DataEnum.BOOLEAN_LITERAL);
                                    if (_equals_15) {
                                      _builder.append("\t");
                                      _builder.append("\t\t");
                                      _builder.append(type, "\t\t\t");
