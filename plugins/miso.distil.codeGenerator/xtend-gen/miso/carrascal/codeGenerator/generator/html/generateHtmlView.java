...
public class generateHtmlView {
  ...
  public CharSequence write(final Artifact artifact) {
    ...
    _builder.newLine();
    {
      boolean _or_5 = false;
      boolean _or_6 = false;
      boolean _contains_9 = basicServices.contains(ServiceEnum.SEARCH_LITERAL);
      if (_contains_9) {
        _or_6 = true;
      } else {
              ...
              if ((att_1 instanceof SimpleAttribute)) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_and_1) {
                    ...
                    boolean _equals_1 = _data_1.equals(DataEnum.DOUBLE_LITERAL);
                    if (_equals_1) {
                      _or_9 = true;
                    } else {
                    ...
                    if (_or_9) {
                      ...
                      boolean _equals_3 = _data_3.equals(DataEnum.INTEGER_LITERAL);
                      _or_8 = _equals_3;
                    }
                    if (!_or_8) {
                      _and_2 = false;
    ...
    }
    {
      ...
      if (_contains_18) {
        ...
        _builder.newLine();
        {
          boolean _contains_19 = basicServices.contains(ServiceEnum.READ_LITERAL);
          if (_contains_19) {
            _builder.append("\t");
            _builder.append("\t\t\t");
            _builder.append("entries.add(new HtmlEntry(Html");
        ...
        _builder.newLineIfNotEmpty();
        {
          boolean _contains_20 = basicServices.contains(ServiceEnum.READ_LITERAL);
          if (_contains_20) {
            _builder.append("\t");
            _builder.append("\t\t\t");
            _builder.append("entries.add(new HtmlEntry(Html");
                  ...
                  if (_isRequired) {
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      ...
                      if (_and_3) {
                        ...
                        boolean _equals_5 = _data_5.equals(DataEnum.DOUBLE_LITERAL);
                        if (_equals_5) {
                          _or_10 = true;
                        } else {
                          DataEnum _data_6 = ((SimpleAttribute)att_2).getData();
                          boolean _equals_6 = _data_6.equals(DataEnum.INTEGER_LITERAL);
                          _or_10 = _equals_6;
                        }
                        if (!_or_10) {
                          _and_4 = false;
              ...
              if ((att_5 instanceof SimpleAttribute)) {
                {
                  ...
                  if (_isRequired_3) {
                    ...
                    _builder.newLineIfNotEmpty();
                    {
                      ...
                      boolean _equals_9 = _data_11.equals(DataEnum.BOOLEAN_LITERAL);
                      if (!_equals_9) {
                        _and_7 = false;
                      } else {
