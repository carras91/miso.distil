...
import miso.carrascal.codeGenerator.validation.AbstractRulesValidator;
import miso.carrascal.codeGenerator.validation.nameVariables;
...
public class RulesValidator extends AbstractRulesValidator {
  ...
  public void chechOnServiceRepeated(final OnService onSer) {
    EList _whenServices = onSer.getWhenServices();
    final Consumer<Object> _function = (Object it) -> {
      EList _whenServices_1 = onSer.getWhenServices();
      int _lastIndexOf = _whenServices_1.lastIndexOf(it);
      EList _whenServices_2 = onSer.getWhenServices();
  ...
  public void checkMultiAttNotRecursive(final Entity ent) {
    EList _attributes = ent.getAttributes();
  ...
  public void checkMultiServiceParameters(final MultiService mulSer) {
    ...
    if (_not) {
      EList _services = mulSer.getServices();
      Object _get = _services.get(0);
      EList<AbstractEntity> out = this.getOutput(((Service) _get));
      for (int j = 1; (j < mulSer.getServices().size()); j++) {
        {
          EList _services_1 = mulSer.getServices();
          Service service = ((EList<Service>) _services_1).get(j);
          int _size = out.size();
          EList<Artifact> _input = this.getInput(service);
          ...
          if (_notEquals) {
            ...
            EList<Artifact> _input_1 = this.getInput(service);
            ...
            EList _services_2 = mulSer.getServices();
          ...
          for (int i = 0; (i < this.getInput(service).size()); i++) {
            ...
            EList<Artifact> _input_2 = this.getInput(service);
            Artifact _get_3 = _input_2.get(i);
            ...
            if (_not_1) {
              ...
              EList<Artifact> _input_3 = this.getInput(service);
              Artifact _get_4 = _input_3.get(i);
  ...
  private EList<Artifact> getInput(final Service service) {
    if ((service instanceof SimpleService)) {
      ...
      if ((service instanceof MultiService)) {
        ...
        if (_isParallel) {
          EList<Artifact> input = new BasicEList<Artifact>();
          EList _services = ((MultiService)service).getServices();
          for (final Service ser : ((EList<Service>) _services)) {
            EList<Artifact> _input = this.getInput(ser);
            input.addAll(_input);
          }
          return input;
        } else {
          EList _services_1 = ((MultiService)service).getServices();
          Object _get = _services_1.get(0);
    ...
    if ((service instanceof SimpleService)) {
      ...
      if ((service instanceof MultiService)) {
        ...
        if (_isParallel) {
          ...
          EList _services_1 = ((MultiService)service).getServices();
          Object _last = IterableExtensions.<Object>last(_services_1);
  ...
  public void checkArtifactDontRepeatBasicServices(final Artifact art) {
    ...
    EList _basicServices = art.getBasicServices();
  ...
  public void checkUniqueNames(final Root root) {
    ...
    EList _artifacts = root.getArtifacts();
    ...
    EList _entities = root.getEntities();
    ...
    EList _services = root.getServices();
