...
public class generateBasicSpark {
  ...
  public CharSequence write(final Artifact artifact) {
    ...
    }
    {
      ...
      if (_contains_13) {
        _builder.append("\t");
        _builder.append("public static String DownloadJson = \"/json/");
        _builder.append(namelow, "\t");
        _builder.append("/download/zip/\";");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("public static String DownloadIdJson = DownloadJson + Basic");
        _builder.append(name, "\t");
        _builder.append("Param.IdGet;");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    {
      ...
      if (_contains_14) {
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.getRead(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
    ...
    }
    {
      ...
      if (_contains_15) {
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.getReadAll(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
    ...
    }
    {
      ...
      if (_contains_16) {
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.getSearch(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
    ...
    }
    {
      ...
      if (_contains_17) {
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.postUpdate(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
    ...
    }
    {
      ...
      if (_contains_18) {
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.postUpload(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
    ...
    }
    {
      ...
      if (_contains_19) {
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.postDelete(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
    ...
    }
    {
      ...
      if (_contains_20) {
        _builder.append("\t\t");
        _builder.append("get(DownloadIdJson, \"application/json\",");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t");
        _builder.append("(request, response) -> {");
        ...
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("Object obj = Json.getDownload(request, response);");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t\t");
        _builder.append("response.body((new JsonTransformer()).render(obj));");
