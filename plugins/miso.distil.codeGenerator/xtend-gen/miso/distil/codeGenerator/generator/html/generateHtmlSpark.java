...
public class generateHtmlSpark {
  ...
  public CharSequence write(final Artifact artifact) {
    ...
    _builder.newLineIfNotEmpty();
    {
      boolean _or_2 = false;
      boolean _or_3 = false;
      boolean _contains_3 = basicServices.contains(ServiceEnum.READ_ALL);
      if (_contains_3) {
        _or_3 = true;
      } else {
    ...
    _builder.newLine();
    {
      ...
      if (_or_6) {
        ...
        boolean _contains_21 = basicServices.contains(ServiceEnum.SEARCH);
        _or_5 = _contains_21;
      }
      if (_or_5) {
        _builder.append("\t\t");
    ...
    _builder.newLine();
    {
      boolean _or_7 = false;
      boolean _or_8 = false;
      boolean _contains_22 = basicServices.contains(ServiceEnum.READ_ALL);
      if (_contains_22) {
        _or_8 = true;
      } else {
        boolean _contains_23 = basicServices.contains(ServiceEnum.UPLOAD);
        _or_8 = _contains_23;
      }
      if (_or_8) {
        _or_7 = true;
      ...
      if (_or_7) {
        ...
        {
          boolean _contains_27 = basicServices.contains(ServiceEnum.SEARCH);
          if (_contains_27) {
            _builder.append("\t");
            _builder.append("\t");
    ...
    _builder.newLine();
    {
      boolean _contains_28 = basicServices.contains(ServiceEnum.READ);
      if (_contains_28) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
    ...
    {
      boolean _contains_29 = basicServices.contains(ServiceEnum.READ_ALL);
      if (_contains_29) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
    ...
    {
      boolean _contains_30 = basicServices.contains(ServiceEnum.SEARCH);
      if (_contains_30) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
    ...
    {
      boolean _contains_31 = basicServices.contains(ServiceEnum.UPDATE);
      if (_contains_31) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
    ...
    {
      boolean _contains_32 = basicServices.contains(ServiceEnum.UPLOAD);
      if (_contains_32) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
