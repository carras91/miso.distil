...
public class generateHtmlView {
  ...
  public CharSequence write(final Artifact artifact) {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Auto-generated html view methods.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* ");
    _builder.newLine();
    ...
    _builder.newLine();
    {
      ...
      if (_contains_13) {
        ...
        {
          boolean _contains_14 = basicServices.contains(ServiceEnum.DOWNLOAD);
          if (_contains_14) {
            _builder.append("\t");
            _builder.append("\t");
        ...
        {
          boolean _contains_16 = basicServices.contains(ServiceEnum.DELETE);
          if (_contains_16) {
            _builder.append("\t");
            _builder.append("\t");
            _builder.append("entries.add(new HtmlEntry(Html");
    ...
    }
    {
      ...
      if (_contains_17) {
        ...
        {
          boolean _contains_21 = basicServices.contains(ServiceEnum.DELETE);
          if (_contains_21) {
            _builder.append("\t");
            _builder.append("\t\t\t");
            _builder.append("entries.add(new HtmlEntry(Html");
    ...
    {
      boolean _contains_22 = basicServices.contains(ServiceEnum.SEARCH);
      if (_contains_22) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
    ...
    {
      boolean _contains_23 = basicServices.contains(ServiceEnum.UPDATE);
      if (_contains_23) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
    ...
    {
      boolean _contains_24 = basicServices.contains(ServiceEnum.UPLOAD);
      if (_contains_24) {
        _builder.append("\t");
        _builder.append("/**");
        _builder.newLine();
