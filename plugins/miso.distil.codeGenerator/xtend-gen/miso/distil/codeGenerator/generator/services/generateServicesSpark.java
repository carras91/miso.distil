      ...
      for(final HashMap<ServiceEnum, ArrayList<Service>> inMap : _values) {
        {
          ...
          if (!(!arrays)) {
            ...
            if (_containsKey) {
              ...
              boolean _containsKey_1 = inMap.containsKey(ServiceEnum.SEARCH);
              _or = _containsKey_1;
            }
            _and = _or;
          }
      ...
      for(final HashMap<ServiceEnum, ArrayList<Service>> inMap_1 : _values_1) {
        {
          ...
          if (!(!upload)) {
            ...
            boolean _or_1 = false;
            boolean _or_2 = false;
            boolean _containsKey_2 = inMap_1.containsKey(ServiceEnum.UPLOAD);
            if (_containsKey_2) {
              _or_2 = true;
            } else {
              boolean _containsKey_3 = inMap_1.containsKey(ServiceEnum.READ_ALL);
              _or_2 = _containsKey_3;
            }
            if (_or_2) {
              _or_1 = true;
            } else {
              boolean _containsKey_4 = inMap_1.containsKey(ServiceEnum.SEARCH);
      ...
      for(final Artifact artifact : _keySet) {
        {
          ...
          boolean _containsKey_5 = _get.containsKey(ServiceEnum.DOWNLOAD);
          if (_containsKey_5) {
            _or_4 = true;
          } else {
            HashMap<ServiceEnum, ArrayList<Service>> _get_1 = map.get(artifact);
            boolean _containsKey_6 = _get_1.containsKey(ServiceEnum.UPDATE);
          ...
          if (_or_4) {
            ...
            boolean _containsKey_7 = _get_2.containsKey(ServiceEnum.READ);
      ...
      for(final Artifact artifact_1 : _keySet_2) {
        {
          ...
          boolean _containsKey_8 = _get_4.containsKey(ServiceEnum.DOWNLOAD);
          if (_containsKey_8) {
            _builder.newLine();
            _builder.append("\t\t");
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_6 = _get_5.get(ServiceEnum.DOWNLOAD);
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_8 = _get_7.get(ServiceEnum.DOWNLOAD);
        ...
        }
        {
          ...
          boolean _containsKey_9 = _get_9.containsKey(ServiceEnum.READ);
          if (_containsKey_9) {
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("after(Basic");
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_11 = _get_10.get(ServiceEnum.READ);
        ...
        }
        {
          ...
          boolean _containsKey_10 = _get_12.containsKey(ServiceEnum.UPDATE);
          if (_containsKey_10) {
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("after(Basic");
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_14 = _get_13.get(ServiceEnum.UPDATE);
        ...
        }
        {
          ...
          boolean _containsKey_11 = _get_15.containsKey(ServiceEnum.UPLOAD);
          if (_containsKey_11) {
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("after(Basic");
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_17 = _get_16.get(ServiceEnum.UPLOAD);
        ...
        }
        {
          ...
          boolean _containsKey_12 = _get_18.containsKey(ServiceEnum.READ_ALL);
          if (_containsKey_12) {
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("after(Basic");
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_20 = _get_19.get(ServiceEnum.READ_ALL);
        ...
        }
        {
          ...
          boolean _containsKey_13 = _get_21.containsKey(ServiceEnum.SEARCH);
          if (_containsKey_13) {
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("after(Basic");
            ...
            _builder.newLine();
            {
              ...
              ArrayList<Service> _get_23 = _get_22.get(ServiceEnum.SEARCH);
