...
public class MdeNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(MdeNatureBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(MdeNatureBuilder.BUILDER_ID);
