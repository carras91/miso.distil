...
public class DistilNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(DistilNatureBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(DistilNatureBuilder.BUILDER_ID);
